    ...
    <div class="container">
        <?php 
            ...
            if (!empty($_POST['boton'])){
                ...
                if ($accion == "Modificar") {
                    ...
                    $modificarlicencia = $licencia->modificarLicencia($id_licencia,$descripcion,$key,$tipo_licencia,$email_relacionado,$password_email,$_SESSION['userLogin']);
                }
                if ($accion == "Consultar") {
        ...
        <form action="licenciasModificar.php" method="post" name="Modlicencia">
            <div class="form-group">
                ...
                <input class='form-control' name='licenciaM' type='text' pattern='{0,50}' title='Ingrese una licencia existente' required>
            </div>
            <div class="form-group">
        ...
        <form action="licenciasModificar.php" method="post" name="formlicencia">
            ...
            <div class="form-group">
                ...
                <input class="form-control"  name="descripcion" type="text" pattern="{0,150}" title="Ingrese descripcion." value="<?=$consultaM["descripcion"]?>" required> 
            </div>
            <div class="form-group">
                <label>Key:</label>
                <input class="form-control"  name="key" type="text" pattern="{0,150}" title="Ingrese key." value="<?=$consultaM["key"]?>" required> 
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control"  name="email_relacionado" type="email" pattern="{0,50}" title="Ingrese email relacionado a la licencia." value="<?=$consultaM["email_relacionado"]?>" required> 
            </div>
            <div class="form-group">
                <label>Contraseña Email:</label>
                <input class="form-control"  name="password_email" type="password" pattern="{0,50}" title="Ingrese contraseña usada para el correo seleccionado." value="<?=$consultaM["password_email"]?>" required> 
            </div>
